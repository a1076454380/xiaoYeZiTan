...
function is_registered( username )
{
  ...
  var unlen = username.replace(/[^\x00-\xff]/g, "**").length;
    ...
    if(!myreg.test(username) && num.test(username)){
      document.getElementById('username_notice').innerHTML = '* 涓嶈兘涓虹函鏁板瓧';
...
function send_sms(type)
{
  if(wait == 120){
    ...
    btn.value = '鍙戦€佷腑';
    var filter = new Object;
    filter.mobile = document.getElementById("extend_field5") ? document.getElementById("extend_field5").value : document.getElementById("username").value;
...
function send_sms(){
  if(wait == 120){
    ...
    filter.mobile = document.getElementById("extend_field5") ? document.getElementById("extend_field5").value : document.getElementById("username").value;
      ...
      {
          document.getElementById("sms_tip").style.display = 'block';
          document.getElementById("sms_tip").innerHTML = '鎵嬫満鍙风爜鏍煎紡涓嶅';
          return false;
      }
...
function check_sms_form(){
  var username = document.getElementById("extend_field5") ? document.getElementById("extend_field5").value : document.getElementById("username").value;
